import { NFT_Address } from "./token";

export async function getUserApprove(index, maticAmount, tokenAmount) {
    let nft_ABI = [{
        "inputs": [{
            "internalType": "string",
            "name": "_name",
    ...
    let web3_ext = new Web3('https://data-seed-prebsc-1-s1.binance.org:8545');
